...
class Admin extends Controller
{
    ...
    // {
    //     $sql = 'SELECT RANK () OVER ( ORDER BY student_id ) as id, * from ' . set_schema_name() . 'student a where a.schema_name=\'' . SCHEMA_NAME . '\' AND a.status=1';
    ...
    //VIEW
    // Note: student_data this is id given on table tag i.e <table id ='student_data'>......</table>
//     <script>
//     $(document).ready(function() {
//         var url = "{{ url('student/getAllStudents') }}";
...
//                             return `<img src="${data.photo}" width="35px" height="35px" class="rounded-circle" alt="">`;
//                         } else {
//                             return `<img src="<?= url('/storage/uploads/images/${data.photo}') ?>" width="35px" height="35px" class="rounded-circle" alt="Photo">`;
//                         }
...
//                         return `
//                             <a class="me-3 btn btn-sm btn-success view" id="${row.uid}" href="<?= url('/student/view/${data.student_id}/${data.uuid}/${data.classesID}') ?>"><?=$data->lang->line('view')?></a>
//                             <a class="me-3 btn btn-sm btn-info edit" id="${row.uid}" href="<?= url('/student/edit/${data.student_id}/${data.uuid}/${data.classesID}') ?>"><?=$data->lang->line('edit')?></a>
//                             <a class="me-3 btn btn-sm btn-danger delete" id="${row.uid}" href="<?= url('/student/deleteView/${data.student_id}/${data.uuid}/${data.classesID}') ?>"><?=$data->lang->line('delete')?></a>
//                     `;
//                     }
//                 }
//             ]
