            ...
            <div class="card-body">
                <div class="card-sales-split">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('edit_purchase', $purchase->uuid) }}"><img
                                    src="{{ asset('assets/img/icons/edit.svg') }}" alt="img"></a>
                        </li>
                        {{-- <li>
                            <a href="{{ route('print_purchase', $purchase->uuid) }}"><img
                                    src="{{ asset('assets/img/icons/pdf.svg') }}" alt="img"></a>
                        </li> --}}
                        <li>
                            <a target="_blank" href="{{ route('print_purchase', $purchase->uuid) }}"><img src="{{ asset('assets/img/icons/printer.svg') }}"
                                    alt="img"></a>
                        </li>
                        @if ($status != 'Completed')
                            <li>
                                <a href="javascript:void(0);" title="Add Payment" class="createpayment"
                                    id="{{ $purchase->uuid }}"><img
                                        src="{{ asset('assets/img/icons/dollar-square.svg') }}" alt="img"></a>
                            </li>
                        @endif
                        <li>
                            <a href="javascript:void(0);" class="delete_purchase" id="{{ $purchase->id }}"><img
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 100%;line-height: inherit;text-align: left;">
                        <tbody>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    {!! site_address($purchase->shop_id) !!}<br>
                                                </td>
                                                <td
                                                    style="padding:5px;vertical-align:top;text-align:left;padding-bottom:20px">
                                                    <font style="vertical-align: inherit;margin-bottom:25px;">
                                                ...
                                                <td
                                                    ...
                                                    <font style="vertical-align: inherit;">
                                                        <font class="{{ $class }}"
                                                            style="vertical-align: inherit;font-size: 14px;font-weight: 400;">
                                                            {{ $status }}
                                                        </font>
                                                    </font><br>
                            ...
                            <tr class="heading " style="background: #F3F2F7;">
                                ...
                                <td
                                    style="padding: 5px;vertical-align: middle;font-weight: 600;color: #5E5873;font-size: 14px;padding: 10px;text-align:right; ">
                                    Subtotal
                                </td>
                            </tr>
