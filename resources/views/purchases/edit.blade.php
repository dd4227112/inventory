        ...
        <form action="{{ route('update_purchase') }}" method="POST">
            ...
            <div class="card">
                <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-10 col-sm-10 col-10">
                                        <select class="select2" id="getSupplier" required name="supplier_id">
                                            <option
                                                value="{{ isset($purchase->supplier) ? $purchase->supplier->id : '' }}"
                                                selected>
                                                {{ isset($purchase->supplier) ? $purchase->supplier->name : '' }}
                                            </option>
                                        </select>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-groupicon">
                                    <input type="date" class="form-control"
                                        ...
                                        value="{{ date('Y-m-d', strtotime($purchase->date)) }}" name="date">
                                    <!-- <div class="addonset">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                <div class="input-groupicon">
                                    <input type="text" placeholder="Please type product name or code and select..."
                                        id="serchProduct" name="searchProduct">
                                    <div class="addonset">
                                ...
                                <tbody id="selectedProduct">
                                    @foreach ($items as $item)
                                        <tr>
                                            ...
                                            <td><input type='text' id='price' readonly name='price[]'
                                                    value="{{ $item->price }}"></td>
                                            <td><input type='text' id='sub_total' readonly name='sub_total[]'
                                                    value="{{ $item->total }}"></td>
                                            <td><a href="javascript:void(0);" id='remove'><img
                                                        src="{{ asset('assets/img/icons/delete.svg') }}"> </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
                    ...
                    <div class="row"
                        style="border: 1px solid #ff9f43; margin-left: 1px; margin-bottom: 5px;border-radius:5px;">
                        <div class="col-lg-6 ">
